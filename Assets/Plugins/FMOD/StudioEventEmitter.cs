...
namespace FMODUnity
{
    ...
    public class StudioEventEmitter : MonoBehaviour
    {
        ...
        public void SetParameterRaw(string name, float value) {
            if (instance != null) {
                instance.setParameterValue(name, value);
            }
        }
        ...
        public float GetParameter(string name) {
            if (instance != null) {
                ...
                instance.getParameter(name, out paramInstance);
                if (paramInstance != null) {
                    float ret;
                    paramInstance.getValue(out ret);
                    return ret;
                } else {
